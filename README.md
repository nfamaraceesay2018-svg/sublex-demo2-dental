# Riverside Dental — Sublex Chat demo site
...
1. Repository:
   `https://github.com/nfamaraceesay2018-svg/sublex-demo2-dental.git`
...
3. Install path: leave it empty, so the files land in the document root of
   **this subdomain**. Check you are on the `demo2.sublexchat.com` entry and
...
or use the SSH URL `git@github.com:nfamaraceesay2018-svg/sublex-demo2-dental.git` with the
...
`demo-sites/site2-dental.mjs` in the Sublex Chat launch folder, with the shared layout
